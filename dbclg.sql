...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 22, 2025 at 01:17 PM
...
(1, 'Cryptohunt', 100, 1, 'images/crypto.png', 1),
(2, 'Search-it', 50, 5, 'images/cs03.jpg', 1),
(3, 'Technical-Quiz', 50, 3, 'images/quiz.png', 1),
(4, 'Competitive-Coding', 50, 1, 'images/coding.jpg', 1),
(5, 'Pubg', 50, 2, 'images/pubg.jpg', 2),
...
INSERT INTO `participent` (`usn`, `name`, `branch`, `sem`, `email`, `phone`, `college`, `password`) VALUES
('1VA17CS005', 'Anu', 'CSE', 5, 'annapoornaba@gmail.com', '8123300011', 'svit', 'password123'),
('1VA17CS012', 'BHAVANA', 'cse', 5, 'BHAVANA@GMAIL.COM', '9934736623', 'Svit', 'password123'),
('1VA17CS022', 'Kavya', 'cse', 5, 'Kavya@gmail.com', '7888387323', 'svit', 'password123'),
('1VA17CS025', 'Mythri', 'ISE', 5, 'mythri@saividya.ac.in', '8998848488', 'svit', 'password123'),
('1VA17CS034', 'Prajwal', 'cse', 5, 'prajwal@gmail.com', '9858787438', 'svit', 'password123'),
('1VA17IS045', 'Prathiksha', 'ISE', 5, 'prathi@gmail.com', '7897854345', 'svit', 'password123'),
('UG00', 'suraj', 'cm', 3, 'suraj123@gmail.com', '0000000000', 'AVCOE', 'password123'),
('UG210', 'atharv', 'aids', 3, 'rajshahi@gmial.com', '0000000000', 'AVCOE', 'password123'),
('UG244', 'Mohit Ghegadmal', 'cm', 0, 'mohitghegadmal2004@gmail.com', '0000000000', 'avcoe', 'password123'),
('UG2440', 'Mohit Ghegadmal', 'cm', 3, 'mohitghegadmal3@gmail.com', '0000000000', 'AVCOE', 'password123'),
('UG24402', 'Mohit ', 'cm', 3, 'mohitghegadmal2004@gmail.com', '0000000000', 'AVCOE', 'password123'),
('UG24403', 'samadhan', 'cm', 3, 'mohitghegadmal2004@gmail.com', '0000000000', 'AVCOE', 'sam');
...
ALTER TABLE `participent`
  ADD PRIMARY KEY (`usn`);
ALTER TABLE `participent` ADD FULLTEXT KEY `usn` (`usn`);
ALTER TABLE `participent` ADD FULLTEXT KEY `usn_2` (`usn`);
...
--
ALTER TABLE `event_info`
  MODIFY `event_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=517;
...
--
ALTER TABLE `staff_coordinator`
  MODIFY `stid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=517;

--
-- AUTO_INCREMENT for table `student_coordinator`
--
ALTER TABLE `student_coordinator`
  MODIFY `sid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=517;
COMMIT;
